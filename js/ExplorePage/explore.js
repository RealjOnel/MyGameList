...
function platformToIconInfo(platformName) {
  ...
  if (p.includes("nintendo entertainment system") || p.includes("famicom") || p.includes("family computer")) {return { src: "../assets/platforms/nintendo/nes.svg", brand: "nintendo", key: "nes" };}
